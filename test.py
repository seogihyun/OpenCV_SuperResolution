...
if __name__ == '__main__':
    ...
    # 추론한 결과물 저장할 파일명 변경
    bicubic.save(args.image_file.replace('.', '_n_bicubic_x{}.'.format(args.scale)))
    ...
    ycbcr = preprocess(bicubic, device)
    ...
    # 저장할 파일명 변경
    output.save(args.image_file.replace('.', '_n_fsrcnn-x_x{}.'.format(args.scale)))
